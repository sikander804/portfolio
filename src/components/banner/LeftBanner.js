...
import { SiJavascript, SiTypescript, SiRubyonrails,SiAmazonaws,SiNextdotjs,SiFirebase,SiNodedotjs } from 'react-icons/si';
  ...
  return (
    <div className="w-full lgl:w-1/2 flex flex-col gap-20">
      <div className="flex flex-col gap-5">
        <h4 className="capitalize text-lg font-normal">CRAFT YOUR VISION. Code IT TO LIFE.</h4>
        ...
        I craft user-centric web & mobile apps.  I transform innovative ideas into beautiful, functional applications that solve real-world problems. Let&apos;s collaborate and bring your vision to life.
